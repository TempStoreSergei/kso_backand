#ifndef QCLASSIC_API_H
#define QCLASSIC_API_H
#include <QByteArray>
#include <QDateTime>
#include <QObject>
#include <QString>
...
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_IMPORT __declspec(dllimport)
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_EXPORT __declspec(dllexport)
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_LOCAL
#else
#if __GNUC__ >= 4
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_IMPORT __attribute__((visibility("default")))
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_EXPORT __attribute__((visibility("default")))
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_LOCAL __attribute__((visibility("hidden")))
#else
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_IMPORT
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_EXPORT
#define QCLASSIC_FR_DRV_NGX_HELPER_DLL_LOCAL
#endif
#endif

#ifdef QCLASSIC_FR_DRV_NGX_DLL // defined if QCLASSIC_FR_DRV_NG is compiled as a DLL
#ifdef QCLASSIC_FR_DRV_NGX_DLL_EXPORTS // defined if we are building the QCLASSIC_FR_DRV_NG DLL (instead of using it)
#define QCLASSIC_FR_DRV_NGX_API QCLASSIC_FR_DRV_NGX_HELPER_DLL_EXPORT
#else
#define QCLASSIC_FR_DRV_NGX_API QCLASSIC_FR_DRV_NGX_HELPER_DLL_IMPORT
#endif // QCLASSIC_FR_DRV_NGX_DLL_EXPORTS
#define QCLASSIC_FR_DRV_NGX_LOCAL QCLASSIC_FR_DRV_NGX_HELPER_DLL_LOCAL
#else // QCLASSIC_FR_DRV_NGX_DLL is not defined: this means QCLASSIC_FR_DRV_NG is a static lib.
#define QCLASSIC_FR_DRV_NGX_API
#define QCLASSIC_FR_DRV_NGX_LOCAL
#endif // QCLASSIC_FR_DRV_NGX_DLL

namespace kkt_driver {
class classic_interface;
}

class QCLASSIC_FR_DRV_NGX_API QClassicFrDrvNg : public QObject {
    ...
    Q_PROPERTY(bool TaxValue7Enabled READ Get_TaxValue7Enabled WRITE Set_TaxValue7Enabled NOTIFY TaxValue7EnabledChanged)
    Q_PROPERTY(bool TaxValue8Enabled READ Get_TaxValue8Enabled WRITE Set_TaxValue8Enabled NOTIFY TaxValue8EnabledChanged)
    Q_PROPERTY(bool TaxValue9Enabled READ Get_TaxValue9Enabled WRITE Set_TaxValue9Enabled NOTIFY TaxValue9EnabledChanged)
    Q_PROPERTY(bool TaxValue10Enabled READ Get_TaxValue10Enabled WRITE Set_TaxValue10Enabled NOTIFY TaxValue10EnabledChanged)
    Q_PROPERTY(bool AddTaxesEnabled READ Get_AddTaxesEnabled WRITE Set_AddTaxesEnabled NOTIFY AddTaxesEnabledChanged)
    ...
    Q_PROPERTY(qint64 TaxValue7 READ Get_TaxValue7 WRITE Set_TaxValue7 NOTIFY TaxValue7Changed)
    Q_PROPERTY(qint64 TaxValue8 READ Get_TaxValue8 WRITE Set_TaxValue8 NOTIFY TaxValue8Changed)
    Q_PROPERTY(qint64 TaxValue9 READ Get_TaxValue9 WRITE Set_TaxValue9 NOTIFY TaxValue9Changed)
    Q_PROPERTY(qint64 TaxValue10 READ Get_TaxValue10 WRITE Set_TaxValue10 NOTIFY TaxValue10Changed)
    ...
    Q_PROPERTY(qint64 Summ17 READ Get_Summ17 WRITE Set_Summ17 NOTIFY Summ17Changed)
    Q_PROPERTY(qint64 Summ18 READ Get_Summ18 WRITE Set_Summ18 NOTIFY Summ18Changed)
    Q_PROPERTY(qint64 Summ19 READ Get_Summ19 WRITE Set_Summ19 NOTIFY Summ19Changed)
    Q_PROPERTY(qint64 Summ20 READ Get_Summ20 WRITE Set_Summ20 NOTIFY Summ20Changed)
...
public slots:
    ...
    qint64 Get_TaxValue7() const;
    void Set_TaxValue7(qint64 value);
    qint64 Get_TaxValue8() const;
    void Set_TaxValue8(qint64 value);
    qint64 Get_TaxValue9() const;
    void Set_TaxValue9(qint64 value);
    qint64 Get_TaxValue10() const;
    void Set_TaxValue10(qint64 value);
    ...
    qint64 Get_Summ17() const;
    qint64 Get_Summ18() const;
    qint64 Get_Summ19() const;
    qint64 Get_Summ20() const;
    void Set_Summ16(qint64 value);
    void Set_Summ17(qint64 value);
    void Set_Summ18(qint64 value);
    void Set_Summ19(qint64 value);
    void Set_Summ20(qint64 value);
...
signals:
    ...
    void TaxValue7EnabledChanged(bool TaxValue7Enabled);
    void TaxValue8EnabledChanged(bool TaxValue8Enabled);
    void TaxValue9EnabledChanged(bool TaxValue9Enabled);
    void AddTaxesEnabledChanged(bool AddTaxesEnabled);
    void TaxValue10EnabledChanged(bool TaxValue10Enabled);
    ...
    void TaxValue7Changed(qint64 TaxValue7);
    void TaxValue8Changed(qint64 TaxValue8);
    void TaxValue9Changed(qint64 TaxValue9);
    void TaxValue10Changed(qint64 TaxValue10);
    ...
    void Summ17Changed(qint64 Summ16);
    void Summ18Changed(qint64 Summ16);
    void Summ19Changed(qint64 Summ16);
    void Summ20Changed(qint64 Summ16);
...
private:
    const std::unique_ptr<kkt_driver::classic_interface> m_pimpl;
};
#endif // QCLASSIC_API_H
